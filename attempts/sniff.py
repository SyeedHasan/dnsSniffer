...
def main():
    sniffedPkts = sniff(count=10)
    packetCount = 0
    for packet in sniffedPkts:
...
# unique_addr = []
# a = sniff(count=5)
# # for layer in get_packet_layers(a[0]):
#     # print(layer.name)
# for packet in a:
...
# for packet in a:
    ...
    # ls(packet[0][DNS])
    # src = packet[0][DNS].ttl
    # dst = packet.dst
    # unique_addr.append([src,dst])
    # unique_addr.append(src)
...
# sniffedPackets = sniff(count=5)
# for i in range(0, len(sniffedPackets)):
# 	print("--------------------------")
# 	print("--------------------------")
# 	print("----- PACKET NUMBER -----------------")
# 	ls(sniffedPackets[i])
# 	# print(sniffedPackets[i][])
# 	print("--------------------------")
# 	print("--------------------------")
# 	print("--------------------------")

# TCPSegment = sniffedPackets[0][TCP]
# print(TCPSegment)
...
#             print("Source IP: " + str(ip_src))
#             print("Dest IP: " + str(ip_dst))
#             # print("Others: " + str(pkt[IP]))

# sniff(store=0, prn=querySniff, count=30)
...
# 	print('TTL : ' + str(ttl) + ' Protocol : ' + str(protocol) + ' Source Address : ' + str(s_addr) + ' Destination Address : ' + str(d_addr))
